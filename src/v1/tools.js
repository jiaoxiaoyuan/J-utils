 ...
 * @param max
 */
export function __random(min, max) {
 ...
 * @param val
 */
export function __containsElement(arr, val) {
 ...
 * @param type
 */
export function __sort(arr, type) {
    return arr.sort((a, b) => {
        switch (type) {
            case 1:
                return a - b;
 ...
 * @param ary
 */
export function __formArray(ary) {
    let arr = [];
 ...
 * @param type
 */
export function __trim(str, type) {
    type = type || 1;
    switch (type) {
        case 1:
 ...
 * @param type
 */
export function __changeCase(str, type) {
    type = type || 4;
    switch (type) {
        case 1:
 ...
 * @param type
 */
export function __getDate(type) {
    let mid;
    const date = new Date();
 ...
 * @param date
 */
export function __formatterDate(date) {
    date = new Date(date);
 ...
 * @param date
 * */
export function __filterymd(date) {
    if (date) {
 ...
 * @returns
 */
export function __formateSecond(value) {
 ...
 * @param val
 */
export function __judgeEndDays(val) {
 ...
 */
export function __besExtract(date, param) {
 ...
 */
export function __handleMinus(val) {
    val = val.replace(/-/g, '');
    return val;
}
 ...
 */
export function __hiddenMidPhone(phone) {
    let reg = /(\d{3})(\d{4})(\d{4})/;
 ...
 * @param phone:验证的手机号码
 */
export function __rulesPhone(phone) {
 ...
 * @param url
 */
export function __combine(baseUrl, url) {
    let u = '';
 ...
 * @returns
 */
export function __timestampToTime(time) {
 ...
 * @returns
 */
export function __judgTrueAndFalse(val) {
    if (!val) {
        return false;
    } else {
        return true;
 ...
 * @returns
 */
export function charAtFindStr(str, index) {
 ...
 * @returns
 */
export function __getParam(param) {
 ...
 * @param {*} value 键值
 */
export function __setCookie(key, value) {
 ...
 * @returns
 */
export function __getCookie(key) {
    let arr,
        reg = new RegExp('(^| )' + key + '=([^;]*)(;|$)');
 ...
 * @param {*} value 键值
 */
export function __setStorage(key, value) {
 ...
 * @returns
 */
export function __getStorage(key) {
 ...
 * @returns
 */
export function __delNullLeafNode(list, key) {
    list.forEach((item) => {
        item[key] === '' ||
        item[key] === undefined ||
        item[key] === null ||
 ...
 * @returns
 */
export function __jsonUnique(arr, key) {
    let map = new Map();
    for (let i of arr) {
 ...
 * @returns
 */
export function __arrUnique(arr) {
    return [...new Set(arr)];
}
 ...
 * @returns
 */
export function __arrFlatten(arr) {
 ...
 * @returns
 */
export function __treeToArray(tree, childs, arrAttr) {
    let attrList = [];
    let list = [];
 ...
 * @returns
 */
export function __arrToTree(data) {
    let result = [];
    let obj = {};
    data.forEach((item) => {
        obj[item.id] = item;
 ...
 * @returns
 */
export function __deepClone(source) {
    let target;
    //对象包含：数组、对象、方法
 ...
 * @returns
 */
export function __arrayUnion(arr1, arr2) {
 ...
 * @returns
 */
export function __arrayIntersect(arr1, arr2) {
 ...
 * @returns
 */
export function __arrayDiff(arr1, arr2) {
    return [...new Set([...arr1].filter((value) => !arr2.includes(value)))];
}
 ...
 * @returns 返回字符串
 */
export function __formatMoney(n) {
    let num = n.toString();
    let len = num.length;
    if (len <= 3) {
        return num;
 ...
 * @returns
 */
export function __camelCaseTo(str) {
 ...
 * @returns
 */
export function __toCamelCase(str) {
 ...
 * @returns 返回自定义位数的时间戳
 */
export function __getNowTimestamp(n) {
    let timeTamp;
    if (n === 10) {
 ...
 * @returns 13位毫秒时间戳
 */
export function __getTimeToStamp(d) {
    let date = new Date(d);
    return date.getTime();
}
 ...
 * @returns
 */
export function __dateComputed(endDate) {
 ...
 */
export function __diffTime(endDate, type) {
 ...
 */
export function __findNode(tree, func, path, dataStructure) {
    if (!tree) return [];
